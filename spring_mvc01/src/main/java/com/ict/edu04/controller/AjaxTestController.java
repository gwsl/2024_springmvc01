...
// RestController 는 리턴하지 않고 브라우저에 출력
...
public class AjaxTestController {
	...
	@ResponseBody
	// 반환형이 String 인 경우 문서 타입 contentType="text.html"로 변경시킨다. 
	...
	public String Xml_Exam03() {
		...
		try {
			  StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty"); /*URL*/
		        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=lmnmxomE1qd1AJboHR0EY3%2FxrVuREYP34Tbppaw%2FLkD68Ew7U5jKVsSIJpL%2F9cWVVHMc6h2%2BJjqcW3e0r7423w%3D%3D");                              /*본인의 서비스키 Service Key*/
	...
	@ResponseBody
	public String Json_Exam03() {
		BufferedReader rd = null;
		HttpURLConnection conn = null;
		try {
			StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/MidFcstInfoService/getMidTa"); /*URL*/
			urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=lmnmxomE1qd1AJboHR0EY3%2FxrVuREYP34Tbppaw%2FLkD68Ew7U5jKVsSIJpL%2F9cWVVHMc6h2%2BJjqcW3e0r7423w%3D%3D"); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
	        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("tmFc","UTF-8") + "=" + URLEncoder.encode("202410160600", "UTF-8")); /*-일 2회(06:00,18:00)회 생성 되며 발표시각을 입력 YYYYMMDD0600 (1800)-최근 24시간 자료만 제공*/
	        URL url = new URL(urlBuilder.toString());
	        conn = (HttpURLConnection) url.openConnection();
	        conn.setRequestMethod("GET");
	        conn.setRequestProperty("Content-type", "application/json");
