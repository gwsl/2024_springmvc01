...
<body>
	...
	<table>
		...
		<tr>
			...
			<font style="color: red">(할인가: <fmt:formatNumber value="${svo.p_saleprice }" pattern="#,##0" /> 원)</font></td>
		</tr>
		<tr>
			<td>제품설명</td>
			<td>${svo.p_content}</td>
		...
		<tr>
			<td colspan="2" align="center"><img src="resources/images/${svo.p_image_l}" width="450px"></td>
		</tr>
		<tr>
